<html>
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
        ...
        function youLost() {
						$.ajax({
								type:"GET",
								data: {'game':'21', 'category':'Points', 'name':'Nathaniel Hayes', 'score':Math.floor(Points)},
							  crossDomain: false,
    ...
    <body onload="setInterval(function(){update();},100);" onkeyup="keydown(event);">
        <h1>Snake, by Nate (V 1.2)</h1>
